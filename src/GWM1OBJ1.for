...
C     VERSION: 20FEB2005
      ...
      PUBLIC::GWM1OBJ1AR,GWM1OBJ1FM,GWM1OBJ1OT
C
...
C-----------------------------------------------------------------------
      ...
      USE GWM1DCV1, ONLY : FVNAME,EVNAME,BVNAME,FVSP,EVSP
...
C-----------------------------------------------------------------------
      ...
      USE GWM1DCV1, ONLY : NFVAR,NEVAR,NBVAR,EVDIR,
     1                     FVNAME,FVDIR,EVNAME,BVNAME
      USE GWM1RMS1, ONLY : CST,RANGENAME,RANGENAMEF
      INTERFACE
        SUBROUTINE USTOP(STOPMESS)
        CHARACTER STOPMESS*(*)
        END
...
C-----FILE-WRITING ERROR
 ...
 9900 FORMAT(/,1X,'*** ERROR WRITING FILE "',A,'" ON UNIT ',I5,/,
     ...
     &7X,'SPECIFIED FILE ACCESS: ',A,/
     &7X,'SPECIFIED FILE ACTION: ',A,/
     &2X,'-- STOP EXECUTION (GWM1OBJ1OT)')
      CALL USTOP(' ')
C
      END SUBROUTINE GWM1OBJ1OT
C
C
      END MODULE GWM1OBJ1