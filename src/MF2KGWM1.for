...
C-------ASSIGN VERSION NUMBER AND DATE
      ...
      PARAMETER (VERSION='MF2K_GWM 1.0.0 022005,FROM MF2K V1.13.00')
C
...
C
C-------REWIND THE SIMULATION MODEL FILES FOR THE NEXT SIMULATION
        IF(.NOT.FIRSTSIM)
...
C-----------IF GWM ACTIVE AND CONVERGENCE HAS FAILED SKIP TO PERTURBATION LOOP END
            IF(IUNIT(55).GT.0)THEN
              MFCNVRG = .FALSE.
              FIRSTSIM = .FALSE. 
              CALL GWM1RMS1FP(MFCNVRG,IPERT,NPERT,LASTSIM)
              GO TO 200
            ENDIF       
C
   33       CONTINUE
