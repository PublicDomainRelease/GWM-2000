...
C-----------------------------------------------------------------------
     ...
     1                     FVILOC,FVJLOC,FVRATIO,FVNAME
      USE GWM1OBJ1, ONLY : OBJTYP,GWM1OBJ1OT,SOLNTYP
      USE GWM1BAS1, ONLY : GWM1BAS1PF
...
C
        ...
        ELSEIF(SOLNTYP.EQ.'SLP'.AND.SLPITCNT.GT.0)THEN ! EXTERNAL AND BINARY 
          CALL GWM1SMC1OT(RSTRT,3)          ! ARE ALSO WRITTEN IN STATUS
        ENDIF
